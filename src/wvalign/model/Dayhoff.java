...
//		bf = new BufferedReader(new FileReader(equilibrium));
	...
	/**
	 * This constructor reads rates, equilibrium probabilities and alphabets from the prescribed
	 * files
	 ...
	 * @throws IOException
	 */
	public Dayhoff(String rate, String equilibrium, String alphabetFile) throws IOException{
		try{
			attachedScoringScheme = new Blosum62();
		}
		catch(FileNotFoundException e){
