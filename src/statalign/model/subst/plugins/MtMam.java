...
/**
 * Implements the mammalian mitochondrial substitution model, see
 * also <a href="http://www.ncbi.nlm.nih.gov/pubmed/9732458">http://www.ncbi.nlm.nih.gov/pubmed/9732458
 * </a>
 * 
 * @author miklos, novak
 */
public class MtMam extends AminoAcidModel {

	public static final String menuName = "Mammalian mitochondrial";
	
	/**
	 * Constructor used when instantiation is necessary. 
	 */
	public MtMam() throws IOException{
		String rate = "data/mtmamMatrix.dat";
		String equilibrium = "data/mtmamEq.dat";
...
//		bf = new BufferedReader(new FileReader(equilibrium));
	 ...
	 * @throws IOException
	 */
	public MtMam(String rate, String equilibrium, String alphabetFile) throws IOException{
		try{
			attachedScoringScheme = new Blosum62();
		}
		catch(FileNotFoundException e){
