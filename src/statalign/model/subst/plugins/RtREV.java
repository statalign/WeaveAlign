...
/**
 * Implements the retrovirus substitution model, see
 * also <a href="http://www.ncbi.nlm.nih.gov/pubmed/12165843">http://www.ncbi.nlm.nih.gov/pubmed/12165843
 * </a>
 * 
 * @author miklos, novak
 */
public class RtREV extends AminoAcidModel {

	public static final String menuName = "Retrovirus";

	/**
	 * Constructor used when instantiation is necessary. 
	 */
	public RtREV() throws IOException{
		String rate = "data/rtrevMatrix.dat";
		String equilibrium = "data/rtrevEq.dat";
...
//		bf = new BufferedReader(new FileReader(equilibrium));
	 ...
	 * @throws IOException
	 */
	public RtREV(String rate, String equilibrium, String alphabetFile) throws IOException{
		try{
			attachedScoringScheme = new Blosum62();
		}
		catch(FileNotFoundException e){
