...
/**
 * This class manages the postrocesses.
 * 
 * @author miklos, novak
 *
 */
...
//			System.out.println(plugin.getTabName()+" "+plugin.selected);
		}
	}
	...
	public void beforeFirstSample() {
		for(Postprocess plugin : plugins){
			plugin.mcmc = mcmc;
			plugin.file = logFile;
			plugin.alignmentType = MainManager.alignmentTypes[mainManager.currentAlignmentType];
			plugin.beforeFirstSample();
		}
	}
